...
Partial Class FormUnidadAlmacenamiento
    ...
    Private Sub InitializeComponent()
        ...
        Label1.Name = "Label1"
        Label1.Size = New Size(638, 49)
        Label1.TabIndex = 15
        Label1.Text = "Conversión de almacenamiento"
        ' 
