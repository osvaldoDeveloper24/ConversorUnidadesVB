...
Partial Class FormUnidadMasa
    ...
    Private Sub InitializeComponent()
        ...
        Label1.TabIndex = 15
        Label1.Text = "Conversión de masa"
        ' 
        ...
        ComboUnidadEquivalencia.Items.AddRange(New Object() {"Milígramo", "Gramo", "Onza", "Libra", "Kilogramo", "Tonelada"})
        ...
        ComboUnidadBase.Items.AddRange(New Object() {"Milígramo", "Gramo", "Onza", "Libra", "Kilogramo", "Tonelada"})
